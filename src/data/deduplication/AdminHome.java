...
public class AdminHome extends javax.swing.JFrame {
    ...
    public AdminHome() {
        super("Cloud Data Deduplication - "+DataDeduplication.userName);
        initComponents();
        scaleImage();
    ...
    public void scaleImage(){
        ImageIcon upload = new ImageIcon("D:\\8th\\Project\\FInal project\\Data Deduplication\\Images\\Upload.png");
        ImageIcon folder = new ImageIcon("D:\\8th\\Project\\FInal project\\Data Deduplication\\Images\\Folder.png");
        Image imgUp = upload.getImage();
        Image imgFolder = folder.getImage();
        Image imageScaleUp  = imgUp.getScaledInstance(30, 30, Image.SCALE_SMOOTH);
        Image imageScaleFolder  = imgFolder.getScaledInstance(30, 30, Image.SCALE_SMOOTH);
        ImageIcon up = new ImageIcon(imageScaleUp);
        ImageIcon view = new ImageIcon(imageScaleFolder);
        uploadFileButton.setIcon(up);
        AllFilesButton.setIcon(view );
    }
    ...
    private void initComponents() {
        ...
        uploadFileButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/utils/Upload.png"))); // NOI18N
        uploadFileButton.setText("Upload File");
        uploadFileButton.setPreferredSize(new java.awt.Dimension(95, 50));
        ...
        AllFilesButton.setPreferredSize(new java.awt.Dimension(77, 50));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(uploadFileButton, javax.swing.GroupLayout.PREFERRED_SIZE, 151, Short.MAX_VALUE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(uploadFileButton, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(AllFilesButton, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );

        UploadFileStatus.setColumns(20);
        UploadFileStatus.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        UploadFileStatus.setForeground(new java.awt.Color(255, 0, 51));
